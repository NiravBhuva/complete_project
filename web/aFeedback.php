...
<div class="grid-info">
	...
	<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, true); function hideURLbar(){ window.scrollTo(0,1); } </script>
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Feedback Table</h3>
...
<tbody>
	<tr>
		...
		<td><a href="FeedbackReply.php">
			 ...
			 href="feedbackdelete.php?id=<?php echo $row['Feedback_id'];?>"><i style="font-size:20px; color:red" class="fa fa-trash-o" aria-hidden="true"></i></a>
		</td>
	</tr>
</tbody>
