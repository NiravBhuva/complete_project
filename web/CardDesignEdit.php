				...
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							...
							<input type="text" name="Name" class="form-control" id="exampleInputEmail1" value="<?php echo $Name;?>"> </div>

								<img src="../web/upload/<?php echo $Image;?>" height=60 width=60/>
								<div class="form-group"> <label for="exampleInputFile">Card_Img</label>
							...
							<input type="number" name="Price" class="form-control" id="exampleInputEmail1" value="<?php echo $Price;?>"> </div> 
