...
if(!isset($_SESSION['user']))
	...
	if(isset($_POST['submit']))
	{
		...
		$q= "INSERT INTO card_info values('','$Category','$Industry','$name','$filename','$price')";
				...
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							...
							<input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Card_name"> </div>
